  ...
  return (
    <div className="bg-[#131313] text-[#E5E2E1] font-sans selection:bg-[#ff5540] selection:text-white min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        {/* Header: BuildersMTY logo + Auth by Shark — side by side */}
        ...
        <div className="space-y-2.5 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 bg-[#1c1b1b] border border-[#603e39]/30 px-3 py-2.5 text-xs font-medium hover:border-[#ff5540]/40 hover:bg-[#201f1f] transition-all"
          >
          ...
          <button
            onClick={() => {/* Placeholder — Shark Auth will handle this */}}
            className="w-full flex items-center justify-center gap-2.5 bg-[#1c1b1b] border border-[#603e39]/30 px-3 py-2.5 text-xs font-medium hover:border-[#5865F2]/40 hover:bg-[#201f1f] transition-all"
          >
        ...
        {/* Email/Password Form */}
        <form onSubmit={(e) => { e.preventDefault(); /* Placeholder — Shark Auth */ }} className="space-y-3 mb-5">
          {mode === "register" && (
            <div>
          ...
          <button
            type="submit"
            className="w-full bg-[#ff5540] text-white px-5 py-3 font-headline text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-[#ff5540]/80 transition-all"
          >
